...
#define ASMPTR(d1, v1, o1) extern DWORD d1##_##v1;
    ...
    FUNCPTR(D2CLIENT, TradeOK, void __stdcall, (void), NULL)      // 1.13C from BH.dll - line ?? grep the codebase
    ...
    FUNCPTR(D2CLIENT, GetGameLanguageCode, DWORD __fastcall, (), NULL) // 1.13C from BH.dll - line ??
    ...
    VARPTR(D2CLIENT, MouseOffsetZ, int, NULL) // 1.13C from BH.dll - line ??- maybe 0x11995F
    ...
    VARPTR(D2CLIENT, ServerSideUnitHashTables, UnitHashTable, NULL) // 1.13C from BH.dll - line ?? maybe 107
    VARPTR(D2CLIENT, ClientSideUnitHashTables, UnitHashTable, NULL) // 1.13C from BH.dll - line ?? maybe 106
    ...
    VARPTR(D2CLIENT, Lang, DWORD, NULL)  // 1.13C from BH.dll - line ??
    ...
    VARPTR(D2CLIENT, pTransactionDialogsInfo, TransactionDialogsInfo_t*, NULL) // 1.13C from BH.dll - line ??
    ...
    VARPTR(D2CLIENT, OrificeId, DWORD, NULL)      // 1.13C from BH.dll - line ??
    VARPTR(D2CLIENT, CursorItemMode, DWORD, NULL) // 1.13C from BH.dll - line ??
    ...
    ASMPTR(D2CLIENT, CongratsScreen_I, NULL) // 1.13C from BH.dll - line ??
    ...
    ASMPTR(D2CLIENT, SendGamePacket_I, NULL) // 1.13C from BH.dll - line ??  //SendPacket_I
    ASMPTR(D2CLIENT, SendPacket_II, NULL)   //// 1.13C from BH.dll - line ?? Updated **NEW** 1.14d //0052AE62-BASE
    ...
    FUNCPTR(D2COMMON, GetLevelNoFromRoom, BOOL __stdcall, (Room1 * pRoom1), NULL)    // 1.13C from BH.dll - line ??
    FUNCPTR(D2COMMON, FindRoom1, Room1* __stdcall, (Act * pAct, int x, int y), NULL) // 1.13C from BH.dll - line ??
    FUNCPTR(D2COMMON, GetItemPalette, int __stdcall, (UnitAny * pPlayer, UnitAny* pItem, BYTE* pColor, int nTransType),
            NULL) // 1.13C from BH.dll - line ??
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // D2Common Globals
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    FUNCPTR(D2NET, ReceivePacket, void __fastcall, (BYTE * aPacket, DWORD aLen), NULL)              // 1.13C from BH.dll - line 398 ??
    FUNCPTR(D2NET, ReceivePacket_I, void __fastcall, (BYTE * aPacket, DWORD aLen, int* arg3), NULL) // 1.13C from BH.dll - line ??
    ...
    ASMPTR(BNCLIENT, DClass, NULL) // 1.13C from BH.dll - line ??
    ASMPTR(BNCLIENT, DLod, NULL)   // 1.13C from BH.dll - line ??
